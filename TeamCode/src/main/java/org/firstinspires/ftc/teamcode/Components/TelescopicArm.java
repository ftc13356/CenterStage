...
public class TelescopicArm extends DualPIDController {
    ...
    public static double LOWBUCKET_EXTEND_POS = 13;
    public static double LOWBUCKET_PITCH_POS = 108;
    public static double HIGHSPECIMEN_EXTEND_POS = 15.75;
...
//    public static double HIGHSPECIMEN_TELE_PITCH_POS = 40.5;
    public static double HIGHSPECIMEN_TELE_PITCH_POS = 37.4;
    ...
    public static double HANG_PITCH_POS = 70, RETRACTED_EXTEND__POS = 0, RETRACTED_PITCH_POS = 0,
            MANUAL_EXT_SPEED = 0.75, MANUAL_ROT_SPEED = 0.5, EXP_HEIGHT_OFFSET=3,
            AUTO_GRAB_PITCH = 7, AUTO_GRAB_EXTEND =14, AUTO_AUTO_GRAB_PITCH = 8.5,
            BACK_PITCH_POS = 97, BACK_EXTEND_POS = 8.5, FRONT_PITCH_POS = 32, FRONT_EXTEND_POS = 1.75;
