...
public class FollowerConstants {
    ...
    public static double xMovement =120.33823123439309*.8;
    public static double yMovement = 80.49790886883019*.8;
    ...
    public static double forwardZeroPowerAcceleration = -36.62719;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -40.15554;
    ...
    public static double zeroPowerAccelerationMultiplier = 4; //lower?
