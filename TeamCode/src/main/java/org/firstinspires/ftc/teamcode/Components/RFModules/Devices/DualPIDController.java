...
//            ,TEST_LEN = 0, MAX_SPEED = 223*751.8/60, MULT = -1, MULT2=-1;
    ...
    public static double  A_OFF = -8, MAX=29, MIN=0
            , ROTMAX = 170, ROTMIN = 0, TICKS_PER_IN = 6.501950585175553e-4, TICKS_PER_DEG = 380/8192.0,P=0.13, S = 0.15, S2 = 0.07 ,D=0.007, rP = 0.009, rP2 =0.01, rD2= .3
