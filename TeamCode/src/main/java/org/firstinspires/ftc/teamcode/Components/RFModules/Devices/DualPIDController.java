...
public class DualPIDController {
    DcMotorEx ext, rot;
    public static double  A_OFF = -14, MAX=30.2, MIN=0, ROTMAX = 160, ROTMIN = 0, TICKS_PER_IN = 20./1526, TICKS_PER_DEG = 90/256.*90/135/2.1*90/65*90/88,P=0.2,D=0, rP = 0.02, rP2 =0.02,rD2= 4, rD = .3, rF = .1, G = 0.15,rG = 0.32, rG2 = .9,TEST_LEN = 0;
    boolean mid=true;
    ...
    public void goTo(double extension, double rotation){
        ...
        if(abs(rd)<5 && abs(rErr)>1.5 && targetRot>3 && curExt<20){
