...
public class DualPIDController {
    ...
    DcMotorEx ext, rot;
    public static double  A_OFF = -9, MAX=30.2, MIN=5, ROTMAX = 160, ROTMIN = 0, TICKS_PER_IN = 0.001821464277011343*4, TICKS_PER_DEG = 360/8192.0,P=0.43,D=0, rP = 0.01 , rP2 =0.02,rD2= 1
    ...
    public void goTo(double extension, double rotation){
        ...
        targetExt = extension;
        targetRot = rotation;
        curExt = ext.getCurrentPosition() + 5.2/TICKS_PER_IN - (.9+x1)*rot.getCurrentPosition()*TICKS_PER_DEG*2786.2/360;
