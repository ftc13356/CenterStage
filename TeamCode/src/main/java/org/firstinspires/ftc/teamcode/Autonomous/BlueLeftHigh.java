...
public class BlueLeftHigh {
    ...
    //parameterize all the significant ones, this should include: pickup pos, intermediate initial pose, initial drop pose, parking poses
    public static double DROP_X = 28.0, DROP_Y = 4.7;
    private double signal=0, lastTime = 0;
    ;
    ...
    public void init() {
        ...
        while (!op.isStarted() && !op.isStopRequested()) {
            signal = robot.checkRobotReadiness();
        }
        op.resetRuntime();
        robot.updateTime();
