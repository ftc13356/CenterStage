...
public class OdometryChassis extends BasicChassis {
   ...
   public double[] track() {
        double data[]={0,0,0};
    double diff[]={
            odomconst[0]*(odom1.getCurrentPosition() - odom[0]),odomconst[1]*(odom2.getCurrentPosition() - odom[1]),odomconst[2]*(odom3.getCurrentPosition() - odom[2])};
