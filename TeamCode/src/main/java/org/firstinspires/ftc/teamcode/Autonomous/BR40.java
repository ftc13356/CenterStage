...
//        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, false);
    ...
    public void grabBluesSweep(){
        ...
        robot.autoReset(false);
        //grab1
        robot.followPath(new Point(39.5+x3,33.25+y3, Point.CARTESIAN),0, -Math.PI/4, false);
        robot.queuer.addDelay(0.5);
        robot.setArm(6.5+x1,5,true);
        robot.queuer.addDelay(0.5);
        robot.setTwist(0.83+x12, true);
        robot.queuer.addDelay(0.5);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
        robot.setArm(6.5+x1,0,false);
...
//        robot.queuer.waitForFinish();
        ...
        robot.setClaw(Claw.ClawStates.OPEN, true);
        //grab2
        robot.followPath(new Point(35.75+x4,23+y4, Point.CARTESIAN),-3*Math.PI/4, -Math.PI/4 , false);
        robot.setTwist(0.83+x12, true);
        robot.setArm(7+x2,5,true);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
        ...
        robot.setClaw(Claw.ClawStates.OPEN, true);
        //grab3
        robot.followPath(new Point(38.5+x8,10+y8, Point.CARTESIAN), -3*Math.PI/4, -Math.PI/4, false);
        robot.queuer.waitForFinish();
        robot.setArm(6+x5,5,true);
        robot.setTwist(0.83+x12, true);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
        robot.setArm(6+x5,0,false);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
        //drop3
        robot.followPath(new Point(27 +x9,21+y9, Point.CARTESIAN), -Math.PI/4, 0, false);
//        robot.setArm(15,3, true);
        ...
        robot.followPath( new Point(22.5+x6, 35.5+y6, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
