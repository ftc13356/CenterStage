...
public class BR40 {
    ...
    public void placeSpeci() {
        robot.followPath(new Point(39.9 + x1, 67, Point.CARTESIAN), 0, 0, false, .9);
...
//        robot.queuer.addDelay(.5);
            robot.followPath(new Point(42 + x1, 72 + position * 4, Point.CARTESIAN), 0, 0, false, .9);
            if (isRed > 0)
                robot.autoGrab(0);
            else
                robot.autoGrab(1);
...
//        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, false);
    ...
    public void grabBluesSweep() {
        ...
        robot.followPath(new Point(34.5 + x3, 30.5 + y3, Point.CARTESIAN), 0, Math.toRadians(-40), false, .8);
        robot.autoReset(true);
        robot.queuer.addDelay(0.7);
        robot.setArm(11.5 + x1, 7, true);
//        robot.queuer.addDelay(0.2);
        ...
        //drop1
        robot.followPath(new Point(29, 27.5, Point.CARTESIAN), -3 * Math.PI / 4, -3 * Math.PI / 4, false, 0.85);
        robot.setArm(13, 5, true);
        robot.queuer.addDelay(DROP_DELAY);
        robot.setClaw(Claw.ClawStates.OPEN, true);
        //grab2
        robot.followPath(new Point(35 + x4, 26.5 + y4, Point.CARTESIAN), Math.toRadians(-44), Math.toRadians(-44), false, .8);
        robot.setTwist(0.83 + x12, true);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.setClaw(Claw.ClawStates.CLOSED, true);
        //drop2
        robot.followPath(new Point(31 + x7, 20 + y7, Point.CARTESIAN), -3 * Math.PI / 4, -3 * Math.PI / 4, false, 0.9);
        robot.setArm(14, 5, true);
        robot.queuer.addDelay(DROP_DELAY);
        robot.setClaw(Claw.ClawStates.OPEN, true);
        //grab3
        robot.followPath(new Point(37 + x8, 14 + y8, Point.CARTESIAN), Math.toRadians(-45), Math.toRadians(-43), false, .8);
        robot.setArm(12.5 + x5, 7, true);
        robot.setTwist(0.83 + x12, true);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.followPath(new Point(18, 23, Point.CARTESIAN), 0, 0, false, false);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.4);
    }
    ...
    public void cycleBlueGrab(int i) {
        robot.queuer.addDelay(0.2);
        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, true);
        robot.followPath(new Point(20+i*CYCLE_OFFSET_X + dist3.getX(), 38 + i*CYCLE_OFFSET_Y + dist3.getY(), Point.CARTESIAN), 0, 0, false,3.5, false);
        robot.queuer.addDelay(0.2);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.queuer.addDelay(0.2);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
...
//        robot.queuer.addDelay(0.3);
    ...
    public void autoBlueGrab(int i) {
        robot.queuer.addDelay(0.5);
        robot.followPath(new Point(23 + dist3.getX(), 23.5 + dist3.getY(), Point.CARTESIAN), 0, 0, false, false);
        robot.queuer.addDelay(0.5);
        ...
        robot.setClaw(Claw.ClawStates.OPEN, true);
        robot.followPath(new Point(18 + dist3.getX(), 23.5 + dist3.getY(), Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.queuer.addDelay(0.3);
        robot.setClaw(Claw.ClawStates.CLOSED, true);
//        robot.queuer.addDelay(0.3);
    ...
    public void placeSpeci2(int i) {
        robot.followPath(new Point(21, 66 + i, 1), new Point(38 + x7, 68 + i, Point.CARTESIAN), 0, 0, false, 0.9);
