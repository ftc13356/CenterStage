...
public class BR40 {
    IDRobot robot;
    public static double x1 = 0, x2 = 0, x3 = 0, x4 = 0, x5 = 0, x6 = 0, x7 = 0, X_OFF = 0.4, Y_OFF = 0.7;
    ...
    public void placeSpeci() {
        ...
        robot.followPath(new Point(39.8 + x1, 64, Point.CARTESIAN), 0, 0, false, .85);
...
//        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, false);
    ...
    public void grabBluesSweep() {
        //grab1
        robot.queuer.addDelay(0.2);
        robot.followPath(new Point(29.8 + x3, 36 + y3, Point.CARTESIAN), 0, Math.toRadians(-40), false, .8);
...
//        robot.queuer.addDelay(0.2);
        ...
        //grab2
        robot.followPath(new Point(31 + x4, 29.0 + y4, Point.CARTESIAN), Math.toRadians(-44), Math.toRadians(-44), false, .8);
        robot.setTwist(0.83 + x12, true);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.setClaw(Claw.ClawStates.GIGA_OPEN, true);
        //grab3
        robot.followPath(new Point(30.5 + x8, 18 + y8, Point.CARTESIAN), Math.toRadians(-45), Math.toRadians(-43), false, .8);
...
//        robot.queuer.addDelay(0.2);
        ...
        //grab4
        robot.followPath(new Point(19, 24.5, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.4);
    ...
    public void cycleBlueGrab(int i) {
        ...
        robot.followPath(new Point(27 + i * X_OFF,42.4 + i * Y_OFF,1), new Point(20.5 + i * X_OFF, 39 + i * Y_OFF, Point.CARTESIAN), 0, 0, false, 1, false);
        robot.queuer.addDelay(0.2);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.queuer.addDelay(0.2);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
...
//        robot.queuer.addDelay(0.3);
    ...
    public void autoBlueGrab(int i) {
        ...
        robot.followPath(new Point(25, 29.5, Point.CARTESIAN), 0, 0 , false, false);
        ...
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.followPath(new Point(19, 26.5, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.queuer.addDelay(0.1);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.3);
    ...
    public void placeSpeci2(int i) {
        ...
        robot.followPath(new Point(21, 66 + i, 1), new Point(38.9 + x7+0.15*i, 68 + i, Point.CARTESIAN), 0, 0, false, 0.9);
