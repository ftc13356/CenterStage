...
public class BR40 {
    ...
    public void placeSpeci() {
        robot.followPath(new Point(38.9 + x1, 67, Point.CARTESIAN), 0, 0, false, .85);
...
//        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, false);
    ...
    public void grabBluesSweep() {
        ...
        robot.followPath(new Point(31.5 + x3, 34 + y3, Point.CARTESIAN), 0, Math.toRadians(-40), false, .8);
...
//        robot.queuer.addDelay(0.2);
        ...
        //drop1
        robot.followPath(new Point(29, 32.5, Point.CARTESIAN), -3 * Math.PI / 4, -3 * Math.PI / 4, false, 0.85);
        robot.setArm(14, 5, true);
        robot.queuer.addDelay(DROP_DELAY);
        robot.setClaw(Claw.ClawStates.GIGA_OPEN, true);
        //grab2
        robot.followPath(new Point(32.5 + x4, 28.5 + y4, Point.CARTESIAN), Math.toRadians(-44), Math.toRadians(-44), false, .8);
        robot.setTwist(0.83 + x12, true);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.setClaw(Claw.ClawStates.GIGA_OPEN, true);
        //grab4
        robot.followPath(new Point(23, 25, Point.CARTESIAN), 0, 0, false, .8);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
...
//        robot.queuer.addDelay(0.4);
    ...
    public void cycleBlueGrab(int i) {
        robot.queuer.addDelay(0.2);
        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, true);
        robot.followPath(new Point(18.5+i*CYCLE_OFFSET_X , 37.5 + i*CYCLE_OFFSET_Y , Point.CARTESIAN), 0, 0, false,3.5, false);
        robot.queuer.addDelay(0.2);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.queuer.addDelay(0.2);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
...
//        robot.queuer.addDelay(0.3);
    ...
    public void autoBlueGrab(int i) {
        ...
        robot.setClaw(Claw.ClawStates.GIGA_OPEN, true);
        robot.followPath(new Point(17 + dist3.getX(), 25.5, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.3);
