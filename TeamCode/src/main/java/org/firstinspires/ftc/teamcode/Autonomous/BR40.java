...
public class BR40 {
    IDRobot robot;
    public static double x1 = 0, x2 = 0, x3 = 0, x4 = 0, x5 = 0, x6 = 0, x7 = 0, X_OFF = 0.35, Y_OFF = 0.55;
    ...
    public void placeSpeci() {
        ...
        robot.followPath(new Point(38.5 + x1, 64, Point.CARTESIAN), 0, 0, false, .85);
        robot.setArm(HIGHSPECIMEN_EXTEND_POS+.25,HIGHSPECIMEN_PITCH_POS, true);
...
//        robot.setArm(TelescopicArm.ArmStates.SPECIMEN_GRAB, false);
    ...
    public void grabBluesSweep() {
        //grab1
        robot.queuer.addDelay(0.2);
        robot.followPath(new Point(31.2 + x3, 35 + y3, Point.CARTESIAN), 0, Math.toRadians(-40), false, .8);
...
//        robot.queuer.addDelay(0.2);
        ...
        //grab2
        robot.followPath(new Point(31 + x4, 30.0 + y4, Point.CARTESIAN), Math.toRadians(-44), Math.toRadians(-44), false, .8);
        robot.setTwist(0.83 + x12, true);
        robot.setArm(14, 4, true);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
//        robot.queuer.addDelay(0.2);
        robot.setArm(13.25, 0, false);
        robot.queuer.addDelay(0.1);
        robot.queuer.queue(false, true);
        robot.setClaw(Claw.ClawStates.CLOSED, true);
        //drop2
        robot.followPath(new Point(30 + x7, 25 + y7, Point.CARTESIAN), -3 * Math.PI / 4, -3 * Math.PI / 4, false, 0.8);
        robot.setArm(14, 5, true);
        robot.queuer.addDelay(0.1);
        robot.setClaw(Claw.ClawStates.GIGA_OPEN, false);
        //grab3
        robot.followPath(new Point(32.5 + x8, 19. + y8, Point.CARTESIAN), Math.toRadians(-45), Math.toRadians(-43), false, .8);
...
//        robot.queuer.addDelay(0.2);
        robot.setClaw(Claw.ClawStates.CLOSED, true);
        //drop3
        robot.followPath(new Point(24.5, 22, Point.CARTESIAN), -Math.PI / 4, 0, false);
        ...
        //grab4
        robot.followPath(new Point(18, 25, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.4);
    ...
    public void cycleBlueGrab(int i) {
        robot.queuer.addDelay(0.2);
        robot.setArm(0, HIGHSPECIMEN_PITCH_POS-3, true);
        robot.queuer.addDelay(0.7);
        robot.setArm(0, SPECIMENGRAB_PITCH_POS, true);
        robot.followPath(new Point(27 + i * X_OFF,37.4 + i * Y_OFF,1), new Point(20 + i * X_OFF, 37 + i * Y_OFF, Point.CARTESIAN), 0, 0, false, 1, false);
        robot.queuer.addDelay(0.2);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.queuer.addDelay(0.2);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
...
//        robot.queuer.addDelay(0.3);
    ...
    public void autoBlueGrab(int i) {
        ...
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.followPath(new Point(18.25, 27.5, Point.CARTESIAN), 0, 0, false, false);
        robot.setTwist(Twist.TwistStates.SPECIMEN, true);
        robot.setFlip(Flip.FlipStates.SPECIMEN_GRAB, true);
        robot.setClaw(Claw.ClawStates.CLOSED, false);
//        robot.queuer.addDelay(0.3);
    ...
    public void placeSpeci2(int i) {
        ...
        robot.followPath(new Point(21, 66 + i, 1), new Point(37.9 + x7+0.15*i, 68 + i, Point.CARTESIAN), 0, 0, false, 0.9);
