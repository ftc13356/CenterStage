...
public class BL04 {
    ...
    public static double X1 = 9, X2 = 28.7, X3= 21.3, X4= 28.4, X6=32, SX1=57.9443447037702, SX2=57.949730700179536, SX3=60.7, SX4=9.0310592459605,SX5=51.70556552962298, SX6=34.77199281867145;
    public static double Y1 = 125, Y2 = 122.75, Y3 = 126.4, Y4=129, Y6=129.9, SY1=101.73339317773788, SY2=122.79353680430879, SY3=106, SY4=126.6858168761221, SY5=119.6983842010772, SY6=118.53500897666068;
...
//      Preload
        ...
        robot.followPath(new Point(X3-2.5, Y3-2.5, Point.CARTESIAN), toRadians(-90), toRadians(-40), false,0.99);
...
//      First Drop
        ...
        robot.followPath(new Point(X3+1.8, Y3-4.8, Point.CARTESIAN), toRadians(H2), toRadians(H3), false, 0.9);
...
//      Second Drop
        ...
        robot.followPath(new Point(X3+0.35, Y3-1.85, Point.CARTESIAN), toRadians(H4), toRadians(H3), false,0.85);
        robot.queuer.addDelay(GRABDROP_DELAY);
        robot.setArm(0,HIGHBUCKET_PITCH_POS, true);
        robot.queuer.addDelay(GRABDROP_DELAY+OTHER_EXT_DELAY);
        robot.setArm(HIGHBUCKET_EXTEND_POS, HIGHBUCKET_PITCH_POS+2, true);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.followPath( new Point(SX5, SY5,1),new Point(SX4-ind*.4, SY4-ind*.4, Point.CARTESIAN), toRadians(-60), toRadians(-38), false ,3.5,false,0.85);
