...
public class BL04 {
    ...
    public static double X1 = 9, X2 = 26.5, X3= 12.75, X4= 27.5, X6=29.5, SX1=59.9443447037702, SX2=57.949730700179536, SX3=60.7, SX4=10.0310592459605,SX5=51.70556552962298, SX6=34.77199281867145;
    public static double Y1 = 125, Y2 = 122.5, Y3 = 129.5, Y4=129, Y6=129, SY1=98.73339317773788, SY2=120.79353680430879, SY3=106, SY4=130.5858168761221, SY5=119.6983842010772, SY6=118.53500897666068;
    public static double H1 = -70, H2 = -11, H3 = -33, H4 = 0, H6=35, H7 = -30;
    public static double EXT1 = 9.5, EXT2 = 9.5, EXT3 = 9.5, CLOSE_DELAY = 0.00, DROP_DELAY_0 = 0.4, DROP_DELAY_1 = 0.6, DROP_DELAY_2= 0.75, DROP_DELAY_3 = 0.7
            , DOWN_DELAY = 0.75, GRABDROP_DELAY = 0.1, STRAFE_DELAY = 0.0;
...
//      Third Drop
    ...
    public void autoGrahCycle(int ind){
        ...
        robot.followPath(new Point(SX2, SY2,1),new Point(SX1+positions[ind]*5, SY1+positions[ind]*1, Point.CARTESIAN), toRadians(-20), toRadians(-87), false, 5, false, 1);
        robot.setArm(0,HIGHBUCKET_PITCH_POS,true);
        robot.queuer.addDelay(0.1);
        robot.setFlip(Flip.FlipStates.SUBMERSIBLE, true);
        robot.queuer.addDelay(DOWN_DELAY);
        ...
        robot.followPath( new Point(SX5, SY5,1),new Point(SX4, SY4, Point.CARTESIAN), toRadians(-60), toRadians(-33), false ,4.7,false,.97);
        robot.setArm(0, HIGHBUCKET_PITCH_POS, true);
