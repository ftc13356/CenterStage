...
public class BL04 {
    ...
    public static double X1 = 9, X2 = 28.2, X3= 18.5, X4= 27.8, X6=31, SX1=57.9443447037702, SX2=57.949730700179536, SX3=60.7, SX4=12.0310592459605,SX5=51.70556552962298, SX6=34.77199281867145;
    public static double Y1 = 125, Y2 = 122, Y3 = 130.5, Y4=129.9, Y6=129.3, SY1=101.73339317773788, SY2=122.79353680430879, SY3=106, SY4=129.0858168761221, SY5=119.6983842010772, SY6=118.53500897666068;
    public static double H1 = -70, H2 = -5, H3 = -30, H4 = 0, H6=35, H7 = -30;
    public static double EXT1 = 13, EXT2 = 13.4, EXT3 = 15, CLOSE_DELAY = 0.00, DROP_DELAY_0 = 0.0, DROP_DELAY_1 = 0.6, DROP_DELAY_2= 0.7, DROP_DELAY_3 = 0.5
...
//      Preload
        ...
        robot.followPath(new Point(X3-2.5, Y3-5, Point.CARTESIAN), toRadians(-90), toRadians(-40), false,0.99);
        robot.setArm(HIGHBUCKET_EXTEND_POS, HIGHBUCKET_PITCH_POS, true);
        robot.setFlip(Flip.FlipStates.BUCKET, true);
        robot.setTwist(Twist.TwistStates.PERPENDICULAR, true);
        robot.queuer.queue(false, robot.twist.getPosition()==1);
        robot.queuer.addDelay(0.04);
...
//      First Drop
        ...
        robot.followPath(new Point(X3, Y3, Point.CARTESIAN), toRadians(H2), toRadians(H3), false, 0.9);
...
//      Second Drop
        ...
        robot.followPath(new Point(X3-1, Y3-1, Point.CARTESIAN), toRadians(H4), toRadians(H3), false,0.9);
        robot.queuer.addDelay(GRABDROP_DELAY);
        robot.setArm(0,HIGHBUCKET_PITCH_POS, true);
        robot.queuer.addDelay(GRABDROP_DELAY+OTHER_EXT_DELAY);
        robot.setArm(HIGHBUCKET_EXTEND_POS, HIGHBUCKET_PITCH_POS+2, true);
...
//      Third Drop
        ...
        robot.followPath(new Point(X3-2, Y3-1, Point.CARTESIAN), toRadians(H6), toRadians(H3), false,0.92);
        robot.queuer.addDelay(GRABDROP_DELAY);
...
//        robot.queuer.addDelay(0.2);
        ...
        robot.followPath( new Point(SX5, SY5,1),new Point(SX4, SY4, Point.CARTESIAN), toRadians(-60), toRadians(-38), false ,3,false,0.95);
        robot.queuer.addDelay(.2);
        robot.setArm(0, HIGHBUCKET_PITCH_POS, true);
